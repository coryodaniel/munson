  ...
  module RSpec
    module Macros
      module StubRequestMacros
        def stub_api_request(document_name, status: 200)
          request_map = {
            ...
            album_404: "http://api.example.com/albums/1",
          ...
          stub_json_get(request_map[document_name], document_name, status: status)
        end

        def stub_json_get(url, document_name, status: 200)
